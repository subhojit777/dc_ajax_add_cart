...
and the total amount including tax. The module also provides other
customizations like showing the product image in shopping cart. You can further
...
2> Go to blocks page admin/structure/block and place the blocks called
   "Custom shopping cart" and "Custom shopping cart teaser" in desired regions.
   ...
   put block "Custom shopping cart" in "Sidebar Second" region and
   "Custom shopping cart teaser" in "User Bar Second" region. Remove the default
   block from "User Bar Second" region.
...
4> Configuration of the module can be found on this page:
   admin/commerce/config/ajax-cart. Shopping cart, shopping cart teaser and
   popup message customizations are also found here.
